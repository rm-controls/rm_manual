...
void ChassisGimbalShooterManual::allowShootAfterDelayCallback(const rm_msgs::GimbalDesError::ConstPtr& data)
{
  ChassisGimbalManual::allowShootAfterDelayCallback(data);
